...
def route(user_message: str, chat_history: List[dict] = None, images: List[str] = None, system_language: str = "ko", active_requests: List[str] = None) -> List[RouterOutputSchema]:
    """

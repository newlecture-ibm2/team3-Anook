...
- **CONTEXT RESET RULE**: If the last AI message in `[과거 대화 맥락]` indicates that a previous request was already COMPLETED, ANSWERED, CONFIRMED, or ESCALATED (e.g., "접수되었습니다", "안내해 드립니다", "완료했습니다", "연결해 드릴게요", "연결해 드리겠습니다", "전달하겠습니다", "준비해 드리겠습니다"), you MUST treat the user's current message as a completely NEW and INDEPENDENT request. DO NOT let the previous department's context or the escalation state bias your domain routing. Evaluate the new message from scratch.

...
export default function FacilityPage() {
  ...
  const { pending, inProgress, completed, loading, error, refetch } = useFrontdeskRequests('FACILITY', searchValue, selectedFilter);
    ...
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        <div className={styles.headerLeft}>
          <h1 className={styles.title}>{t.frontdeskPage.taskBoard.titles.facility}</h1>
        </div>

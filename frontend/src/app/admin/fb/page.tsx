...
export default function FbPage() {
  ...
  const { pending, inProgress, completed, loading, error, refetch } = useAdminRequests('FB', searchValue, selectedFilter);
    ...
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        <div className={styles.headerLeft}>
          <h1 className={styles.title}>{t.adminPage.taskBoard.titles.fb}</h1>
        </div>

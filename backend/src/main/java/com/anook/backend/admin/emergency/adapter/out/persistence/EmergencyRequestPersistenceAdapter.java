package com.anook.backend.admin.emergency.adapter.out.persistence;

import com.anook.backend.admin.emergency.application.port.out.EmergencyRequestCommandPort;
import com.anook.backend.admin.emergency.application.port.out.EmergencyRequestQueryPort;
